    ...
    <td align="center">
        ...
        <!-- Блок номер 1 -->
         <span style="display:inline-block; width:600px;">
             <b>Активация аккаунта №{{ $user_id }} в программе "ЕТК-Клуб"</b>
         </span>
        <!-- Блок номер 1 -->
 <!--[if gte mso 9]>
 </td></tr></table>
...
<table border="0" cellpadding="0" cellspacing="0" style="margin:0; padding:0; background:#ffffff;" width="100%">
  <tr>
    <td align="center>
        ...
        <!-- Блок номер 1 -->
         <span style="display:inline-block; width:600px;">
             <p>Остался всего один шаг! Для завершения регистрации в программе "ЕТК-Клуб" перейдите по <a href="http://etk-club.ru/verify_account/{{ $token }}/activate">ссылке</a>.</p>
              <hr>
              <p>Для авторизации в дальнейшем используйте в качестве логина адрес электронной почты <b>{{ $email }}</b> и пароль <b>{{ $psw }}</b>.</p>
